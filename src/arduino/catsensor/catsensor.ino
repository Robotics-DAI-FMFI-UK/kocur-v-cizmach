...
void automatic_move_head_left()
{
  ...
  read_touch();
  delay(100);
  while (touch > 80 || serial_available() || Serial.available()){
    read_touch();
    move_head_left();
  }
}
...
void print_usage()
{
  ...
  {   
    ...
    serial_println_flash(PSTR(" 7: move head left"));
    serial_println_flash(PSTR(" 8: move head right"));
    serial_println_flash(PSTR(" 9: automatic move head left"));  
    serial_println_flash(PSTR(" 0: automatic move head right"));
  } 
  delay(150); 
