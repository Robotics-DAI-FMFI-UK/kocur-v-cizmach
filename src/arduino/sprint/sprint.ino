...
82,90,100,80,135,145,25,45,1,
92,90,100,110,161,145,25,15,1,
...
100,40,90,158,135,90,35,49,1,
45,40,90,158,93,90,35,49,1,
...
{      
    ...
    do {
      ...
      else if ((ypr[0] * 180 / M_PI >= -7) && (ypr[0] * 180 / M_PI <= 7)) {
        if (natocenie == 1)
        { 
           automatic_move_head_right();
        }
...
void automatic_move_head_left()
{
  ...
  read_touch();
  delay(100);
  while (touch > 80 && !Serial.available()){
    read_touch();
    move_head_left();
  }
}
